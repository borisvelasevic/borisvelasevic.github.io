      ...
      <section className="about section">
        <div className="container">
          ...
          <div className="about-content">
            ...
            <p>
              Previously, I was a Quantitative Researcher at <a href="https://www.twosigma.com" target="_blank" rel="noopener noreferrer" className="text-link">Two Sigma</a>. I earned my MEng and two BS degrees (CS & Engineering, Mathematics) from <a href="https://web.mit.edu/" target="_blank" rel="noopener noreferrer" className="text-link">MIT</a>. I worked with Professor <a href="https://azizan.mit.edu" target="_blank" rel="noopener noreferrer" className="text-link">Navid Azizan</a> on distributed linear system solvers, winning the <a href="https://urop.mit.edu/mentors/outstanding-student/student-recipients/" target="_blank" rel="noopener noreferrer" className="text-link">"Outstanding UROP Student Award"</a>.
            </p>
            <p>
              I represented Bosnia and Herzegovina at the <a href="https://www.imo-official.org/year_info.aspx?year=2018" target="_blank" rel="noopener noreferrer" className="text-link">59th</a> and <a href="https://www.imo-official.org/year_info.aspx?year=2019" target="_blank" rel="noopener noreferrer" className="text-link">60th</a> International Mathematical Olympiad (Bronze & Honourable Mention). I mentor at the School for Talented Mathematicians in Sarajevo and served on the problem selection committee for the 42nd Balkan Mathematical Olympiad.
            </p>
          </div>
        </div>
      </section>
